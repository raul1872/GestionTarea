...
namespace GestionTarea.Services
{
    public interface ITaskService
    {
        ...
        Task<List<Tarea>> ListarTareasAsync(bool? completada = null, DateTime? fechaVencimiento = null);
        ...
        Task<EstadisticasTareasViewModel> ObtenerEstadisticasAsync(int usuarioId);
